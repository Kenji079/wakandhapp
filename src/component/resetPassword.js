            ...
            <View style={styles.container}>
                ...
                <View style={{ marginTop: wp('10%'), padding: 30 }}>
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <Text style={{fontSize:22, fontWeight:'bold', textAlign:'center', marginTop:20}}>Continue with email</Text>
                        <Text style={{fontSize:16, textAlign:'center', color:'#8f92a1', marginTop:10}}>You'll receive 4 digit code to verify next.</Text>

                        <View style={{ marginTop: wp('0%'), alignContent: 'center', alignItems: 'center' }}>
                            <KeyboardAvoidingView behavior="padding">

                                <Text style={{ color: "#88888B", fontSize: 15, marginLeft: wp('8%'), fontWeight: 'bold', marginTop:50 }}>EMAIL ADDRESS</Text>
                            ...
                            <GradientButton
                                ...
                                impact
                                impactStyle='Light'
                                onPressAction={() => this.props.navigation.navigate('OTP')}
                            />
