            ...
            <View style={styles.container}>
                ...
                <View style={{ marginTop: wp('10%'), padding: 30 }}>
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <Image style={styles.logo} source={require('./../image/icon/lock.png')} />

                        <Text style={{ fontSize: 24, fontWeight: 'bold', textAlign: 'center', marginTop: 20 }}>New Password</Text>
                        <Text style={{ fontSize: 18, textAlign: 'center', color: '#8f92a1', marginTop: 10 }}>Your new password must be different from previous used password</Text>

                        <View style={{ marginTop: wp('10%'), alignContent: 'center', alignItems: 'center' }}>
